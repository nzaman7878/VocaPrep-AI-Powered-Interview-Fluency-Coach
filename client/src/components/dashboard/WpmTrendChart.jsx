  ...
  return (
    <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm h-80 flex flex-col">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h3 className="text-lg font-bold text-slate-800 font-display">Pacing Trend</h3>
          <p className="text-sm text-slate-500">Average Words Per Minute (WPM) per session</p>
        </div>
